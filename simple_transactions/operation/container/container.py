...
def _init_container() -> Container:
    ...
    container.register(TransactionService, scope=Scope.singleton)

    from simple_transactions.operation.services.auth_client import AuthClientService

    container.register(AuthClientService, scope=Scope.singleton)
